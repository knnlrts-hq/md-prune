...
- systematically clean up unused code, misnamed methods, etc in order to avoid code rot and bloat.
...
- For data processing:
  - **ALWAYS** use `polars` instead of other dataframe libraries for tabular data manipulation.
